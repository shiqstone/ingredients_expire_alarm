...
///    function.
///
/// The [BottomSheetSelf] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] or
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showModalBottomSheetSelf].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showModalBottomSheetSelf], which can be used to display a modal bottom
///    sheet.
///  * <https://material.io/design/components/sheets-bottom.html>
class BottomSheetSelf extends StatefulWidget {
  /// Creates a bottom sheet.
  ///
  /// Typically, bottom sheets are created implicitly by
  /// [ScaffoldState.showBottomSheet], for persistent bottom sheets, or by
  /// [showModalBottomSheetSelf], for modal bottom sheets.
  const BottomSheetSelf({
    Key? key,
  ...
  @override
  _BottomSheetSelfState createState() => _BottomSheetSelfState();

  /// Creates an [AnimationController] suitable for a
  /// [BottomSheetSelf.animationController].
  ///
...
class _BottomSheetSelfState extends State<BottomSheetSelf> {
...
class _ModalBottomSheetState<T> extends State<_ModalBottomSheet<T>> {
  ...
  void handleDragEnd(DragEndDetails details, {bool isClosing = false}) {
...
class _ModalBottomSheetRoute<T> extends PopupRoute<T> {
  ...
  AnimationController createAnimationController() {
    ...
    _animationController = BottomSheetSelf.createAnimationController(navigator!.overlay!);
...
/// display the [BottomSheetSelf] when set to `true`. This is useful in the case
/// that a modal [BottomSheetSelf] needs to be displayed above all other content
...
/// See also:
///
///  * [BottomSheetSelf], which becomes the parent of the widget returned by the
...
Future<T?> showModalBottomSheetSelf<T>({
  ...
  return Navigator.of(context, rootNavigator: useRootNavigator).push(_ModalBottomSheetRoute<T>(
    ...
    enableDrag: enableDrag,
    settings: routeSettings ?? const RouteSettings(),
  ));
}
...
/// [showModalBottomSheetSelf] function.
///
